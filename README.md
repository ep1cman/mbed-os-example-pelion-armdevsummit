...
1. Update the firmware version in the [`cytfm_pelion_policy.json`](https://github.com/ARMmbed/mbed-os-example-pelion-armdevsummit/blob/armdevsummit/TARGET_CYTFM_064B0S2_4343W/policy/cytfm_pelion_policy.json) file:
...
- If the Python commands fail to run:
    ...
    - If you quit Mbed Studio, close and re-open the terminal within Mbed Studio. This resets it to a known good state.
...
- If the device does not start downloading the update:
    - Ensure that the firmware version is set correctly in the correct section of **[`cytfm_pelion_policy.json`](https://github.com/ARMmbed/mbed-os-example-pelion-armdevsummit/blob/armdevsummit/TARGET_CYTFM_064B0S2_4343W/policy/cytfm_pelion_policy.json)**.
